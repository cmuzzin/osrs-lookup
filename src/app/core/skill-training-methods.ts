...
// than a sourced fact: Zalcano and Tithe Farm (both scale with
// contribution/fruit count, no stated rate) and Sorceress's Garden (only
...
export const SKILL_TRAINING_METHODS: Partial<Record<string, TrainingMethod[]>> = {
  ...
  woodcutting: [
    ...
    { name: 'Quests and trees (efficient)', levelReq: 1, xpPerHour: 29_000, tags: ['clicky'] },
  ...
  fishing: [
    { name: 'Quests', levelReq: 1, xpPerHour: 29_200, tags: ['afk'] },
  ...
  agility: [
    { name: 'Quests', levelReq: 1, xpPerHour: 15_100, tags: ['afk'] },
  ...
  farming: [
    { name: 'Quests', levelReq: 1, xpPerHour: 16_000, tags: ['afk'] },
    { name: 'Tree runs', levelReq: 38, xpPerHour: 304_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 45, xpPerHour: 506_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 55, xpPerHour: 719_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 60, xpPerHour: 1_083_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 68, xpPerHour: 1_362_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 75, xpPerHour: 1_896_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 81, xpPerHour: 2_314_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 85, xpPerHour: 2_475_000, tags: ['afk', 'buyable', 'profit'] },
    { name: 'Tree runs', levelReq: 90, xpPerHour: 2_500_000, tags: ['afk', 'buyable', 'profit'] },
  ],
  runecrafting: [
  ...
  hunter: [
    { name: 'Varrock museum and birdhouses', levelReq: 1, xpPerHour: 30_000, tags: ['afk', 'passive'] },
  ...
  sailing: [
    { name: 'Port tasks, Charting & Quests', levelReq: 1, xpPerHour: 10_000, tags: ['afk'] },
    { name: 'Barracuda trials (The Tempor Tantrum)', levelReq: 30, xpPerHour: 25_000, tags: ['clicky'] },
    { name: 'Large shipwrecks with boost', levelReq: 50, xpPerHour: 35_000, tags: ['afk', 'profit'] },
